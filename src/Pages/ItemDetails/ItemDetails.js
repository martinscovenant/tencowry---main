            ...
            {loading ? (
              ...
              <>
                ...
                <div className='flex items-center gap-3'>
                  <div className='rounded h-[30px] w-[30px] bg-black flex items-center justify-center cursor-not-allowed p-1'> <FontAwesomeIcon icon={faArrowLeft} className='!text-white !text-sm' /> </div>
                  <span className='text-[#ff5c40]'>1</span>
                  <div className='rounded h-[30px] w-[30px] bg-black flex items-center justify-center cursor-not-allowed p-1'> <FontAwesomeIcon icon={faArrowRight} className='!text-white !text-sm' /> </div>
                </div>
              </>
            )}
          </div>
